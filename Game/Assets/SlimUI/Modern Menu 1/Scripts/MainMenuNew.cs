...
public class MainMenuNew : MonoBehaviour {
    ...
    [Header("Multiplayer")]
    public GameObject multiRandm;
    public GameObject multifriend;
    ...
    public void disableMultiSubMenu()
    {     
        multifriend.SetActive(false);
        multiRandm.SetActive(false);
    }

    public void multiSubMenu()
    {
        DisablePlayCampaign();
        PanelareYouSure.gameObject.SetActive(false);

        multifriend.SetActive(true);
        multiRandm.SetActive(true);
    }
